    ...
    return __generator(this, function (_h) {
      switch (_h.label) {
        ...
        case 6:
          ...
          subID = item.subId;
          libs.log(
            { linkDetail: linkDetail, title: title, lang: lang, subID: subID },
            PROVIDER,
            "SUB==>"
          );
        ...
        case 7:
          dataSub = _h.sent();
          libs.log(
            { dataSub: dataSub, body: body_1, urlGetSub: urlGetSub },
            PROVIDER,
            "== DATA SUB==>"
          );
          ...
          urlDownload = "https://api.subsource.net/api/downloadSub/".concat(
            token
          );
          libs.log(
            {
