    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 1:
          ...
          subLanguageIds = [];
          url = "https://rest.opensubtitles.org/search/imdbid-".concat(
            movieInfo.imdb_id.replace("tt", "")
          );
        ...
        case 4:
          ...
          urlLang = "https://rest.opensubtitles.org/search/imdbid-"
            .concat(movieInfo.imdb_id.replace("tt", ""), "/sublanguageid-")
            .concat(item.id);
          return [
            4,
            fetch(urlLang, {
        ...
        case 6:
          dataLang = _b.sent();
          libs.log(
            { urlLang: urlLang, dataLang: dataLang, item: item },
            PROVIDER,
            "URL SEARCH LANG"
          );
        ...
        case 8:
          for (_a = 0, data_1 = data; _a < data_1.length; _a++) {
            ...
            libs.log(
              { lang: lang, subLang: subLang[lang], zip: item.ZipDownloadLink },
              PROVIDER,
              "LANG INFO"
            );
            if (!subLang[lang]) {
