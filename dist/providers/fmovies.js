        ...
        switch (_b.label) {
            ...
            case 2:
                ...
                parseSearch_1('.flw-item').each(function (key, item) {
                    ...
                    var year = parseSearch_1(item).find('.fdi-item').first().text();
                    var type = parseSearch_1(item).find('.fdi-type').text();
                    ...
                    if (title && href && !LINK_DETAIL_1 && type) {
                        if (libs.string_matching_title(movieInfo, title)) {
                            if (movieInfo.type == 'tv' && type.toLowerCase() == 'tv') {
                                ...
                                TV_LINK_DETAIL_2.push(tvLinkDetail);
                ...
                libs.log({ TV_LINK_DETAIL: TV_LINK_DETAIL_2 }, PROVIDER, 'TV_LINK_DETAIL');
                flagTv_1 = false;
                if (!(movieInfo.type == 'tv' && TV_LINK_DETAIL_2.length)) return [3, 6];
                            ...
                            case 1:
                                ...
                                parseTvLinkDetail('.m_i-d-content .elements .row-line').each(function (keyTv, itemTv) {
                                    ...
                                    if (text && text.toLowerCase().indexOf('released') != -1) {
                                        ...
                                        if (yearTv == movieInfo.year && !flagTv_1) {
                                            flagTv_1 = true;
                                            LINK_DETAIL_1 = linkTvItem;
                                        }
                                    }
                                });
                                return [2];
                ...
                _i = 0, TV_LINK_DETAIL_1 = TV_LINK_DETAIL_2;
                _b.label = 3;
            case 3:
                if (!(_i < TV_LINK_DETAIL_1.length)) return [3, 6];
            ...
            case 6:
                ...
                parseId = LINK_DETAIL_1.split('-');
                filmId = parseId[parseId.length - 1];
                libs.log(filmId, PROVIDER, "FILM ID");
                if (!filmId) {
                    return [2];
                }
                serverIds_2 = [];
                if (!(movieInfo.type == 'movie')) return [3, 8];
            ...
            case 7:
                ...
                libs.log({ parseEmbedServer: parseEmbedServer_1 }, PROVIDER, "PARSE EMBED SERVER");
            ...
            case 11:
                ...
                _b.label = 12;
            case 12:
                libs.log({ serverIds: serverIds_2 }, PROVIDER, 'SERVER IDS');
                extractDirect = function (url) { return __awaiter(_this, void 0, void 0, function () {
                    var dataRabbit, source3, parseTrack, tracks, _i, parseTrack_2, trackItem, lang, parseLang, rank, _a, source3_1, item, directSizes, patternSize, directQuality, _b, patternSize_1, patternItem, sizeQuality;
                    return __generator(this, function (_c) {
                        switch (_c.label) {
                ...
                opensslKeyIv_1 = function (password, salt, keyLen, ivLen) {
                ...
                decryptOpenssl = function (encBase64, password) {
                    try {
                        ...
                        var _a = opensslKeyIv_1(password, salt, 32, 16), key = _a.key, iv = _a.iv;
