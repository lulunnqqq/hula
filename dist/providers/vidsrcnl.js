...
source.getResource = function (movieInfo, config, callback) { return __awaiter(_this, void 0, void 0, function () {
    var PROVIDER, DOMAIN, headers, urlSearch, parseSearch, iframeURL, parseIframe, directURL, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                iframeURL = iframeURL.replace("/embed/", "/stream/");
                libs.log({ iframeURL: iframeURL }, PROVIDER, "IFRAME PARSE");
                return [4, libs.request_get(iframeURL, headers, true)];
            case 3:
                parseIframe = _a.sent();
                directURL = parseIframe('media-player').attr("src");
