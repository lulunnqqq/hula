    ...
    return __generator(this, function (_a) {
        ...
        fflix = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        urlSearch = "".concat(DOMAIN, "/nflimy13.php?tmdb=").concat(movieInfo.tmdb_id);
                        if (movieInfo.type == 'tv') {
                            urlSearch = "".concat(DOMAIN, "/nflimy13.php?tmdb=").concat(movieInfo.tmdb_id, "&season=").concat(movieInfo.season, "&episode=").concat(movieInfo.episode);
                        }
                        libs.log({
                            urlSearch: urlSearch
                        }, PROVIDER, 'URL SEARCH');
