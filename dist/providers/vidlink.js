        ...
        switch (_d.label) {
            ...
            case 10:
                ...
                if (parseDirecturl.length > 1) {
                    ...
                    decodeHeader = encodeURIComponent("{" + parseDirecturl[1]);
                    directUrl = directUrl + "/" + decodeHeader;
                }
