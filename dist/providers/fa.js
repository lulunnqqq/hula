...
source.getResource = function (movieInfo, config, callback) { return __awaiter(_this, void 0, void 0, function () {
    var PROVIDER, DOMAIN, userAgent, LINK_DETAIL, KEY, gen, a, encode, headers, urlSearch, parseSearch, SERVER_ID, tvid, tvInfoUrl, tvInfo, parseTvInfo_1, embedTokens_1, _a, _b, _i, episodeItem, token, urlGetEmbed, embedData, urlEmbed, encodeEmbed, movieId, movieInfoUrl, movieInfo_1, parseMovieInfo, episodeToken, _c, _d, _e, episodeItem, token, urlGetEmbed, embedData, urlEmbed, encodeEmbed;
    return __generator(this, function (_f) {
        switch (_f.label) {
            case 0:
                ...
                encode = function (url) {
                    return decodeURIComponent(a.Mi(KEY, a.mi(url)));
                };
                headers = {
