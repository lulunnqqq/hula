...
hosts["2embed"] = function (url, movieInfo, provider, config, callback) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                parseEmbed = _a.sent();
                embed = parseEmbed('video#player source').attr('src');
                libs.log({
                    length: parseEmbed('video#player source').length,
                    embed: embed
                }, provider, 'EMBED VIDEO');
                if (!embed) {
                    return [2];
                }
                embed = "https://2embed.biz/play/".concat(embed);
                libs.log({
                    embed: embed
